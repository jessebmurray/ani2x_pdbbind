...
#SBATCH -J ani2x_pdbbind_rand
#SBATCH --mail-user=jesse.murray@stats.ox.ac.uk
#S BATCH --nodelist=nagagpu01.cpu.stats.ox.ac.uk
#SBATCH --clusters srf_gpu_01 -w nagagpu01.cpu.stats.ox.ac.uk
...
python /data/localhost/not-backed-up/jemurray/ani2x_pdbbind/run_ani2x_rand.py
